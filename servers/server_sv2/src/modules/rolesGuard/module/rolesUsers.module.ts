...
@Module({
    imports: [TypeOrmModule.forFeature([TCAGroupsWEB, TCAGroupUsersWEB, TCAMenusWEB, TCARolesUsersWEB, TCARootMenusWEB]), TypeOrmModule.forRoot(sqlServerITMV20240117),],
    providers: [
        DatabaseService,
        SystemUsersService
    ],
