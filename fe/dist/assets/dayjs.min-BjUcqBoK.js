import { g as Q, c as K } from './index-C0Ym1P--.js'
var E = { exports: {} }
;(function (V, X) {
  ;(function (W, k) {
    V.exports = k()
    ...
    var W = 1e3,
      ...
      P = {
        ...
        p: function (s) {
          return (
            { M: m, y: v, w: T, d: M, D: _, h: O, m: w, s: S, ms: A, Q: U }[
              s
            ] ||
            String(s || '')
              .toLowerCase()
        ...
        return (
          ...
          (n.startOf = function (t, r) {
            var e = this,
              ...
              o = function (p, $) {
                var y = a.w(
                  e.$u ? Date.UTC(e.$y, $, p) : new Date(e.$y, $, p),
                  e,
                )
              ...
              c = function (p, $) {
                return a.w(
                  e
                    ...
                    [
                      p
                    ].apply(e.toDate('s'), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice($)),
                  e,
                )
              },
              h = this.$W,
          ...
          (n.$set = function (t, r) {
            var e,
              ...
              (e[A] = u + 'Milliseconds'),
              e)[i],
              c = i === M ? this.$D + (r - this.$W) : r
            if (i === m || i === v) {
              var h = this.clone().set(_, 1)
              h.$d[o](c),
                h.init(),
                (this.$d = h.set(_, Math.min(this.$D, h.daysInMonth())).$d)
            } else o && this.$d[o](c)
          ...
          (n.add = function (t, r) {
            ...
            if (u === M) return o(1)
            if (u === T) return o(7)
            var c = ((e = {}), (e[w] = k), (e[O] = N), (e[S] = W), e)[u] || 1,
          ...
          (n.diff = function (t, r, e) {
            var i,
              ...
              o = a.p(r),
              c = f(t),
              h = (c.utcOffset() - this.utcOffset()) * k,
              d = this - c,
              l = function () {
                return a.m(u, c)
              }
