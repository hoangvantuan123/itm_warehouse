...
export default function StockOutRequestQueryFiFo({ filteredData, handleCheckBarcode, inputBarCode,
  setInputBarCode, setCheckValueIsStop }) {
      ...
      > <Row className="gap-4 flex items-center">
          ...
          <Col>
            ...
            <Form.Item
              ...
              className="mb-0"
            >
              {filteredData?.IsStop === true ? <><Checkbox onChange={onChange}><span className='uppercase'>Đơn hàng hoàn thành</span></Checkbox></> : <>   <Checkbox onChange={onChange}>{checkBoxIsStop ? <span className=' uppercase'>Đơn hàng hoàn thành</span> : <span className='uppercase'>Đơn hàng chưa hoàn thành</span>}</Checkbox></>}
