...
export default function StockOutRequestQueryDetails({
    formData,
    setFormData,
    setToDate,
    toDate,
    ...
    return (
        <div className="flex items-center gap-2">
            <Form layout="vertical">
                ...
                <Col>
                        <Form.Item
                            label={<span className="uppercase text-[10px]">Ngày yêu cầu</span>}
                            className="mb-0"
                        >
                            <DatePicker
                    ...
                    <Col>
                        <Form.Item
                            label={<span className="uppercase text-[10px]">Bộ phân</span>}
                            className="mb-0"
                        >
                            <Input
                    ...
                    <Col>
                        <Form.Item
                            label={<span className="uppercase text-[10px]">Ghi chú</span>}
                            className="mb-0"
                        >
                            <Input
