...
function TableLabelPreview({ setData }) {
    ...
    const onChangeZplCode = async (e) => {
        ...
        try {
            const response = await fetch(`http://api.labelary.com/v1/printers/${device}/labels/${sizeWidth}x${sizeHigh}/0/`, options);
                    ...
                    <Splitter layout="vertical">
                        <Splitter.Panel>
                            ...
                            <Form layout="vertical">
                                ...
                                >
                                    <Input placeholder="With" style={{ width: '20%' }} onChange={onChangeSizeWidth} />
                                    <Input placeholder="High" style={{ width: '20%' }} onChange={onChangeSizeHigh} />
                                    <Select
                                        optionFilterProp="label"
                                ...
                                <Form.Item>
                                    <TextArea rows={20} value={zplCode} onChange={onChangeZplCode} />
                                    <br />
