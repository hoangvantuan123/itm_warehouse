...
function TableUsers({ data }) {
    ...
    const columns = [
        ...
        { name: 'EmpName', header: 'Họ và Tên', width: 220, sortable: true, filter: 'text' },
        ...
        { name: 'EmpEngFirstName', header: 'Tên Tiếng Anh', sortable: true, filter: 'text' },
        { name: 'EmpEngLastName', header: 'Họ Tiếng Anh', sortable: true, filter: 'text' },
