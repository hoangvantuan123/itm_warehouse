...
import { Card, Button, Modal, Space, Input, Typography, DatePicker, Select, Form, Row, Col } from 'antd';
                    ...
                    >
                        ...
                        <Row className="flex m-0 p-0 gap-11 items-end">
                            ...
                            <Form.Item label="1D Size" layout={"inline"} >
                                <div className="flex gap-3">
                                    <Form.Item name="barcodeSizeX" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="X" type="number" min={0} step={0.1} />
                                    </Form.Item>

                                    <Form.Item name="barcodeSizeY" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="Y" type="number" min={0} step={0.1} />
                                    </Form.Item>
                                </div>
                            ...
                            <Form.Item label="2D Position" layout={"inline"}>
                                ...
                                <div className="flex gap-3">
                                    <Form.Item name="qrcodePosX" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="X" type="number" min={0} step={0.1} />
                                    </Form.Item>

                                    <Form.Item name="qrcodePosY" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="Y" type="number" min={0} step={0.1} />
                                    </Form.Item>
                                </div>
                            ...
                            <Form.Item label="2D Size" layout={"inline"}>
                                <div className="flex gap-3">
                                    <Form.Item name="qrcodeSizeX" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="X" type="number" min={0} step={0.1} />
                                    </Form.Item>
                                    <Form.Item name="qrcodeSizeY" className="w-36 m-0 p-0" layout={"inline"} >
                                        <Input placeholder="Y" type="number" min={0} step={0.1} />
                                    </Form.Item>
                                </div>
