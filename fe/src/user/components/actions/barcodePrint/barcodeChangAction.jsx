    ...
    const handleKeyDownOldBarcode = async (e) => {
        if (e.key === 'Enter') {
            ...
            try {
                ...
                const result = await checkConfirmBarcode(
                    dataConfirm
                );
    ...
    const onKeyDownNewBarcode = async (e) => {
        if (e.key === 'Enter') {
            ...
            try {
                ...
                const result = await checkConfirmNewBarcode(
                    dataConfirm
                );
                ...
                if (result != null) {
                    ...
                    const isDuplicate = data.some(
                        row => row.newBarcode === newRow.newBarcode && row.oldBarcode === newRow.oldBarcode
                    );
                ...
                >
                    ...
                    >
                        ...
                        <Form.Item label="New Barcode" name="newBarcode" layout={"inline"} >
                            <Input size="small" style={{ width: 320 }} ref={newBarcodeRef} onKeyDown={onKeyDownNewBarcode} />
                        </Form.Item>
