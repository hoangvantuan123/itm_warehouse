...
import { Card, Button, Modal, Space, Input, Typography, DatePicker, Checkbox, Row, Col, Select, message } from 'antd';
            ...
            <Card className="mb-2 p-2 shadow-sm" size="small">
                ...
                >
                    <Space direction="horizontal" size={6}>
                        ...
                        <Input className="w-20 bg-blue-50" placeholder="PORT" required={true} value={port} onChange={(e) => setPort(e.target.value)} />
                        <Input className="w-50 bg-blue-50" placeholder="IP" required={true} value={ip} onChange={(e) => setIP(e.target.value)} />
