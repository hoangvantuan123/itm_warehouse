...
export default function KittingConfirmQuery({
  formData,
  setFormData,
  setToDate,
  toDate,
      ...
      >
        <Row className="gap-4 flex items-center ">
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">From Date</span>
              }
              className="mb-0"
            >
              <DatePicker
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">To Date</span>
              }
              className="mb-0"
            >
              <DatePicker
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">SMD LINE</span>
              }
              className="mb-0"
            >
              <Select
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">MAT ID</span>
              }
              className="mb-0"
            >
              <Input
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">LOT NO</span>
              }
              className="mb-0"
            >
              <Input
