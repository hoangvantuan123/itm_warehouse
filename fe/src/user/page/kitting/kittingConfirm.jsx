...
import KittingConfirmAction from '../../components/actions/kitting/kittingConfirmAction'
export default function KittingConfirm({ permissions, isMobile }) {
  ...
  return (
    <>
      <Helmet>
        <title>ITM - {t('Confirm Kitting')}</title>
      </Helmet>
